...
namespace Villa_Web.Service
{
    public class VillaService : BaseServices, IVillaService
    {
        ...
        public Task<T> Create<T>(VillaCreateDTO villaCreateDTO)
        {
        ...
        public Task<T> Delete<T>(int id)
        {
            return SendAsync<T>(new APIRequest()
            {
                ...
                Url = VillaURL + "/API/Villa/Id?id=" + id
            });
        }
        ...
        public Task<T> Update<T>(VillaUpdateDTO villaUpdateDTO)
        {
            return SendAsync<T>(new APIRequest()
            {
                apiType = SD.APIType.PUT,
                Data = villaUpdateDTO,
                Url = VillaURL + "/API/Villa/id?id=" + villaUpdateDTO.Id
            });
        }
    }
}
